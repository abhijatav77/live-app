    ...
    <div className='bg-white rounded-xl shadow-lg p-6 border border-gray-100'>
        ...
        <div className='flex items-center space-x-2'>
          <div className='flex-1 relative'>
            <input 
              ...
              value={roomId}
              readOnly
              className='w-full px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-50 font-mono text-lg tracking-wider text-center focus:outline-none focus:border-blue-500 transition-colors'
            />
          </div>
          <button
      ...
      <div className='mb-5'>
        ...
        <div className='flex items-center space-x-2'>
            <input 
              ...
              value={shareableLink}
              readOnly
              className='flex-1 px-4 py-3 border-2 border-gray-200 rounded-lg bg-gray-50 tracking-wider text-center focus:outline-none focus:border-green-500 transition-colors'
            />
          <button
            onClick={onCopyLink}
      ...
      <div className='grid grid-cols-2 gap-4 pt-5 border-t border-gray-200'>
        <div className='bg-linear-to-br from-green-50 to-emerald-50 p-4 rounded-lg border border-green-100'>
          ...
          <p className='text-xs font-bold text-green-600 capitalize'>
            {status}
          </p>
        </div>
