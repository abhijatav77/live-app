  ...
  return (
    <div className='max-w-2xl mx-auto bg-white rounded-2xl shadow-2xl p-8 border border-gray-100'>
      <div className='text-center mb-8'>
        <div className='inline-flex items-center justify-center w-16 h-16 bg-green-500 to-emerald-600 rounded-2xl shadow-lg mb-4'>
      ...
      <form onSubmit={onSubmit} className='space-y-6'>
        ...
        <button
          type='submit'
          disabled={loading}
          className='w-full flex justify-center items-center py-4 px-6 bg-linear-to-r from-green-600 to-emerald-600 rounded-xl shadow-sm text-lg font-semibold text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all transform hover:scale-[1.02]'
        >
          {loading ? (
            <>
