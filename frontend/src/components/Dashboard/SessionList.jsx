...
// ✅ ADD THIS FUNCTION (formatDate helper)
    ...
    <div className='mt-16 max-w-5xl mx-auto bg-white rounded-2xl shadow-lg border border-gray-100 p-6'>
      ...
      {loading && sessions.length === 0 ? (
        ...
        <div className='space-y-4'>
          {sessions.map((s) => (
            <div key={s.id} className='border border-gray-200 rounded-xl p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 hover:shadow-md transition-shadow'>
